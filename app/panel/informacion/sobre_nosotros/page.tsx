...
export default function Sobre_nosotros() {
  return (
    <section
      className={`${roboto.className} flex flex-col gap-14 justify-center items-center my-18 md:gap-12 lg:gap-10`}
    >
      <div className="flex flex-col gap-4 p-6 w-[280px] h-min rounded-md bg-[#D9D9D9] md:w-[500px] lg:w-[500px]">
        ...
        <p>
          En <span className="font-bold">AutoCaucho</span>, somos apasionados
      ...
      <div className="flex flex-col justify-center align-center gap-14 p-6 w-[295px] h-min rounded-md bg-[#D9D9D9] md:w-[700px] md:flex-row md:gap-30 lg:w-[900px] lg:flex-row lg:m-8 lg:p-10 lg:gap-30">
        <div className="flex flex-col gap-4">
          <span className={`font-bold text-center text-[20px]`}>MISIÓN</span>
          <p>
        ...
        <div className="flex flex-col gap-4">
          <span className={`font-bold text-center text-[20px]`}>VISIÓN</span>
          <p>
      ...
      <div className="flex flex-col gap-10 p-6 w-[295px] h-min rounded-md bg-[#D9D9D9] md:p-8 md:w-[700px] lg:p-8 lg:w-[900px]">
        <span className={`font-bold text-center text-[20px]`}>
          ¿Por qué Elegirnos?
        </span>
        <article>
