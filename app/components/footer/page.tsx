...
const nosotros = [
  {
    name: "Quiénes somos",
    link: "/panel/informacion/sobre_nosotros",
  },
  {
  ...
  },
  {
    ...
    link: "/panel/informacion/terminos_y_condiciones",
  },
  {
    name: "Política de privacidad",
    link: "/panel/informacion/politicas_de_privacidad",
  },
];
  ...
  return (
    <footer className={`${roboto.className} w-full bg-[#D9D9D9] text-black `}>
        ...
        <article className="flex justify-evenly items-center gap-12">
          <div className="flex flex-col justify-center items-center gap-2 md:mb-23 lg:mb-26">
            <div className="gap-2 flex flex-col">
              <span
                className={`${roboto.className} font-extrabold text-[#408FD8] pb-1`}
              >
                Sobre nosotros
              </span>
              {nosotros.map((product) => (
                <Link
                  key={product.name}
                  href={product.link}
        ...
        <article className="flex justify-evenly items-center gap-2">
          <div className="gap-6 flex flex-col">
            <div className="gap-4 flex flex-col">
              <span
                className={`${roboto.className} text-center font-extrabold text-[#408FD8] `}
              >
                Síguenos para Más Ofertas y Noticias
              </span>
              <figure className="flex justify-center items-center gap-4">
                <FaFacebookSquare
                  className={`cursor-pointer text-black h-10 w-10`}
                />
                <FaInstagramSquare
                  className={`cursor-pointer text-black h-10 w-10`}
                />
            ...
            <div className="gap-3 flex flex-col">
              <span
                className={`${roboto.className} font-extrabold text-[#408FD8]`}
              >
              ...
              <div className="gap-1 flex flex-col">
                <div>
                  <p className="flex items-center gap-2 mb-2">
                    <FaWhatsapp
                      className={`cursor-pointer text-black h-6 w-6`}
                    />
                    <span
                      className={`${roboto.className} font-extrabold text-center text-black`}
                    >
                      +57 321 576 ....
                    </span>
                  </p>
                ...
                {InfoContacto.map((info, index) => {
                  return (
                    <p key={index} className="flex flex-col  ">
                      ...
                      <span
                        className={`${roboto.className} font-light text-black`}
                      >
                        {info.name}
                      </span>
                    </p>
      ...
      <section className="w-full flex flex-col justify-center text-center gap-3 py-5 bg-[#023D71] font-bold text-white">
        <span className={`${roboto.className} text-extrabold text-2xl`}>
          Formas de Pago
        </span>
